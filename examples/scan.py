...
import xlsxwriter
import pandas as pd
inputs = input("How many barcodes would you like to scan: ")
num_barcodes = int(inputs)

workbook = openpyxl.load_workbook('LOSOS.xlsx')
worksheet = workbook.active

#inputs = input("How many barcodes are you scanning")
